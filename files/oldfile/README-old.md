...
41        image: docker.io/v5cn/prometheus-adapter:v0.12.0
manifests/kubeStateMetrics-deployment.yaml
35        image: registry.k8s.io/kube-state-metrics/kube-state-metrics:v2.19.0
...
# 执行安装后需要先改grafana的limits和数据的持久化,limits太小会造成oom，数据持久化改emptyDir为自己的持久化目录   
#    volumes:
#      - emptyDir: {}
...
```
  - /etc/containerd/config.toml  （containerd = v1.x）
```yaml
    [plugins."io.containerd.grpc.v1.cri".registry]
      [plugins."io.containerd.grpc.v1.cri".registry.configs]
        [plugins."io.containerd.grpc.v1.cri".registry.configs."{{ harbor_domain }}".tls]
      ...
      [plugins."io.containerd.grpc.v1.cri".registry.mirrors]
        [plugins."io.containerd.grpc.v1.cri".registry.mirrors."docker.io"]
          endpoint = ["https://{{ harbor_domain }}"]
```
   - /etc/containerd/config.toml  （containerd = v2.x）
```
...
root@master1:/etc/apt/sources.list.d# apt-cache madison kubeadm
   ...
   kubeadm | 1.33.13-1.1 | https://pkgs.k8s.io/core:/stable:/v1.33/deb  Packages
   kubeadm | 1.33.12-1.1 | https://pkgs.k8s.io/core:/stable:/v1.33/deb  Packages
   kubeadm | 1.33.11-1.1 | https://pkgs.k8s.io/core:/stable:/v1.33/deb  Packages
   kubeadm | 1.33.10-1.1 | https://pkgs.k8s.io/core:/stable:/v1.33/deb  Packages
   kubeadm | 1.33.9-1.1 | https://pkgs.k8s.io/core:/stable:/v1.33/deb  Packages
   kubeadm | 1.33.8-1.1 | https://pkgs.k8s.io/core:/stable:/v1.33/deb  Packages
   ...
   kubeadm | 1.32.13-1.1 | https://pkgs.k8s.io/core:/stable:/v1.32/deb  Packages
   kubeadm | 1.32.12-1.1 | https://pkgs.k8s.io/core:/stable:/v1.32/deb  Packages
   kubeadm | 1.32.11-1.1 | https://pkgs.k8s.io/core:/stable:/v1.32/deb  Packages
